...
%  TODO: a bit repetitive, try to remove some of the neuroimaging terms.
...
Moreover, frequently used smoothing techniques reduced the resolution \tristan{smoothing doesn't reduce the resolution. You could say that smoothing may have a similar effect than reducing precision} in similar fashion
