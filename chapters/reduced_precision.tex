...
\HL{This is amplified by the current lack of understanding of the effects from applying
reduced precision to a range of different applications and, in general, the precision required for a specific application.}
...
\HL{
	...
	At the opposite, software implementation is less efficient but tend to be more portable.
	...
	either a software or hardware implementation to obtain performance improvements.
}
